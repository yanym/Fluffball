...
1. Use `Assets/Pets/Nina/Generated/AIReferenceImages/generation-ready/stand/front.png` as the primary identity reference for face shape, eyes, nose, ear placement, and chest markings.
...
| `std/sit_left.png` | `Assets/Pets/Nina/Generated/AIReferenceImages/generation-ready/sit/left-profile.png` |
| `std/lie_right.png` | `Assets/Pets/Nina/Generated/AIReferenceImages/generation-ready/lie/right-profile.png` |
