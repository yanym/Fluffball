...
- Pet Pack v2 素材清单 `manifest.json`：声明图片/视频能力和两套 27 个语义动作
...
- The Pet Pack v2 `manifest.json`, declaring image/video capabilities and both sets of 27 semantic actions
